...
class CustomReport:
    ...
    def createHTMLReport(self, reportFile, reportTitle):
        ...
        with open(reportFile, 'w') as fileHandle:
            ...
            fileHandle.write("<link rel='stylesheet' href='https://cdn.datatables.net/1.10.19/css/dataTables.bootstrap4.min.css'>" + "\n")
            fileHandle.write("<link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.1.3/css/bootstrap.css'>" + "\n")
            fileHandle.write("<script src='https://code.jquery.com/jquery-3.3.1.js'></script>" + "\n")
            fileHandle.write("<script src='https://cdn.datatables.net/1.10.19/js/jquery.dataTables.min.js'></script>" + "\n")
            fileHandle.write("<script src='https://cdn.datatables.net/1.10.19/js/dataTables.bootstrap4.min.js'></script>" + "\n")
            fileHandle.write("<!-- This is required for collapse -->" + "\n")
            fileHandle.write("<script src='https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js'></script>")
